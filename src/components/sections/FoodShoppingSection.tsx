    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="space-y-2 mb-3">
          ...
          <div className="flex items-center text-xs text-gray-600">
            <JapaneseYen size={12} className="mr-1" />
        ...
        <div className="flex flex-wrap gap-1">
          {place.specialties.slice(0, 3).map((specialty, index) => (
            <span key={index} className="bg-kinari text-deep-blue text-xs px-2 py-1 rounded-full">
              {specialty}
            </span>
          ))}
        </div>
    ...
    <section className="py-16 md:py-20 bg-white">
      <Container>
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <h3 className="text-2xl font-semibold mb-6 text-center text-deep-blue">グルメスポット</h3>
        ...
        >
          <h3 className="text-lg font-semibold mb-3 text-deep-blue">お得な情報</h3>
